...
DF_TARGET_VEL_MS_X: float = 0.0
DF_TARGET_VEL_MS_Y: float = 0.0
DF_TARGET_VEL_MS_Z: float = 0.0
...
def init_state():
    ...
    sset("target_vel_ms_x", DF_TARGET_VEL_MS_X)
    sset("target_vel_ms_y", DF_TARGET_VEL_MS_Y)
    sset("target_vel_ms_z", DF_TARGET_VEL_MS_Z)
    # INITIAL: RADAR
